    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            {!! Form::open(array('route' => 'lists.store', 'data-parsley-validate' => '')) !!}
                ...
                {{ Form::text('product1', null, array('class' => 'form-control', 'required' => '', 'minlength' => '3')) }}

                {{ Form::label('product2', 'Product 2:', ['class' => 'form-spacing-top']) }}
                {{ Form::text('product2', null, array('class' => 'form-control', 'required' => '', 'minlength' => '3')) }}

                {{ Form::label('product3', 'Product 3:', ['class' => 'form-spacing-top']) }}
                {{ Form::text('product3', null, array('class' => 'form-control', 'required' => '', 'minlength' => '3')) }}

                {{ Form::label('product4', 'Product 4:', ['class' => 'form-spacing-top']) }}
                {{ Form::text('product4', null, array('class' => 'form-control', 'required' => '', 'minlength' => '3')) }}
                
                {{ Form::label('product5', 'Product 5:', ['class' => 'form-spacing-top']) }}
                {{ Form::text('product5', null, array('class' => 'form-control', 'required' => '', 'minlength' => '3')) }}
